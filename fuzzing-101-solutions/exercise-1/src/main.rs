...
fn main() {
    ...
    let corpus_dirs = vec![PathBuf::from("/home/lzy/Code/LibAFL-101/fuzzing-101-solutions/exercise-1/corpus")];
    ...
    let fork_server = ForkserverExecutor::new(
        "/home/lzy/Code/LibAFL-101/fuzzing-101-solutions/exercise-1/xpdf/install/bin/pdftotext".to_string(),
        &[String::from("@@")],
